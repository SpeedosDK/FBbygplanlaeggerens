...
public class c {
    public static void main(String[] args) {
        ...
        // gul
        if (time.equals("aften") && (traffic.equals("lav")) || time.equals("nat") && (traffic.equals("lav"))) {
            System.out.println("Trafiklyset er gult");
        }
        // rød
        if (time.equals("nat") && (traffic.equals("høj")) || (areaType.equals("bolig") && traffic.equals("høj"))) {
        ...
        else System.out.println("Adgang tilladt"); {
